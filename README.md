...
These Swift wrappers have been tested with glib-2.46, 2.48, 2.52, 2.56, 2.58, 2.60, 2.61, and 2.62.  They should work with higher versions, but YMMV.  Also make sure you have `gobject-introspection` and its `.gir` files installed.
...
## Documentation
You can find reference documentation inside the [docs](https://rhx.github.io/SwiftGIO/) folder.
